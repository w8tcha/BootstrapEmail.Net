...
internal static class ValueExtensions
{
    ...
    public static Length ToLength(this FontSize fontSize)
    {
        ...
        {
            FontSize.Big => //1.5em
                new Length(1.5f, Length.Unit.Em),
            FontSize.Huge => //2em
                new Length(2f, Length.Unit.Em),
            FontSize.Large => //1.2em
                new Length(1.2f, Length.Unit.Em),
            FontSize.Larger => //*120%
                new Length(120f, Length.Unit.Percent),
            FontSize.Little => //0.75em
                new Length(0.75f, Length.Unit.Em),
            FontSize.Small => //8/9em
                new Length(8f / 9f, Length.Unit.Em),
            FontSize.Smaller => //*80%
                new Length(80f, Length.Unit.Percent),
            FontSize.Tiny => //0.6em
                new Length(0.6f, Length.Unit.Em),
